...
export const ChatView: React.FC<ChatViewProps> = ({
    ...
    const showTyping = isPlaying && currentFrameIndex < frames.length - 1 &&
    ...
    const highlightText = (text: string) => {
        ...
        return parts.map((part, i) =>
            part.toLowerCase() === searchQuery.toLowerCase()
                ? <mark key={i} className="bg-blue-500 text-white px-1 rounded font-bold shadow-[0_0_10px_rgba(59,130,246,0.5)]">{part}</mark>
                : part
        );
    };
